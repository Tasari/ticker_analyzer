...
_EXPORTS = {
    ...
    "SCORING_VERSION": "ticker_analyzer.ranking.versions",
    "PROVIDER_SCHEMA_VERSION": "ticker_analyzer.ranking.versions",
    "METRIC_SCHEMA_VERSION": "ticker_analyzer.ranking.versions",
    "config_digest": "ticker_analyzer.ranking.versions",
    "analysis_fingerprint": "ticker_analyzer.ranking.versions",
