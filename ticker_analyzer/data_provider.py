...
class YFinanceProvider:
    def fetch(self, ticker_symbol: str, ranges: AnalysisRanges) -> MarketData:
        ...
        return MarketData(
            ...
            growth_history=safe_frame(lambda: ticker.history(period=ranges.growth.lower(), auto_adjust=False)),
            value_history=safe_frame(lambda: ticker.history(period=ranges.value.lower(), auto_adjust=False)),
